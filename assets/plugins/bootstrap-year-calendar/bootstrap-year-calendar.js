	...
	Calendar.prototype = {
		...
		_initializeOptions: function(opt) {
			...
			this.options = {
				...
				yearChange:$.isFunction(opt.yearChange) ? opt.yearChange : null,
			};
		...
		_renderHeader: function() {
			...
			prevIcon.addClass('fas fa-angle-left');
			...
			nextIcon.addClass('fas fa-angle-right');
		...
		_renderBody: function() {
			...
			monthsDiv.addClass('row months-container');
			...
			$('.row.months-container').css('display','flex');
		},
		...
		_applyEvents: function () {
			...
			setInterval(function() {
				...
				var monthContainerClass = 'month-container month-padding col-sm-4';
				//col-md-3 col-sm-4
		...
		setYear: function(year) {
			...
			if($.isFunction(this.options.yearChange)){
				this.options.yearChange(parsedYear);
			}
			if(!isNaN(parsedYear)) {
