                ...
                <form id="customerForm">
                    <div class="form-group mb-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fname" @if($isEdit==true) value="{{ $EditData[0]->CName }}" @endif placeholder="Name">
                    ...
                    <div class="form-group mb-1 row">
                        <div class="form-group col-6">
                            ...
                            <input type="email" class="form-control" @if($isEdit==true) value="{{ $EditData[0]->Email }}" @endif id="email" placeholder="bernard@hackwell.com">
                            <span class="small mt-1 text-danger" data-validation data-error="Email"></span>
                        </div>
                        <div class="form-group col-6">
                            <label for="lname">Phone number</label>
                            <input type="number" min="6000000000" max="9999999999" class="form-control" id="phone" @if($isEdit==true) value="{{ $EditData[0]->MobileNumber }}" @endif placeholder="(+91) 6374867931">
