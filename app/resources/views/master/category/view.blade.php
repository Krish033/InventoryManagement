							...
							<div class="card-header text-center">
								<div class="form-row align-items-center">
									...
									<div class="col-md-4 my-2 text-right text-md-right">
										@if ($crud['restore'] == 1)
											<a class="btn btn-outline-dark btn-sm m-r-10" href="{{ url('/') }}/master/category/trash-view"
												type="button"> Trash view </a>
										@endif
										@if ($crud['add'] == 1)
											<a class="btn  btn-outline-success btn-air-success btn-sm" href="{{ url('/') }}/master/category/create"
			...
			const LoadTable = async () => {
				@if ($crud['view'] == 1)
					$('#tblCategory').dataTable({
						...
						"bServerSide": true,
						"ajax": {
							"url": RootUrl + "master/category/data?_token=" + $('meta[name=_token]')
								.attr('content'),
							"headers": {
