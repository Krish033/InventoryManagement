		...
		<div class="row">
			<div class="col-sm-12">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="{{ url('/') }}/master/category/" data-original-title="" title="">Category</a></li>
						...
						<div class="card-header text-center">
							<div class="form-row align-items-center">
								...
								<div class="col-md-4 my-2">
									<h5>Category Trash View</h5>
								</div>
								<div class="col-md-4 my-2 text-right text-md-right">
									<a href="{{ url('/') }}/master/category/" class="btn  btn-outline-light btn-sm m-r-10" type="button" > Back</a>
								</div>
							</div>
						</div>
						<div class="card-body " >
    ...
    $(document).ready(function(){
        ...
        const LoadTable=async()=>{
			...
			$('#tblCategory').dataTable( {
				"bProcessing": true,
				"bServerSide": true,
                "ajax": {"url": RootUrl+"master/category/trash-data?_token="+$('meta[name=_token]').attr('content'),"headers":{ 'X-CSRF-Token' : $('meta[name=_token]').attr('content') } ,"type": "POST"},
				deferRender: true,
				responsive: true,
				dom: 'Bfrtip',
				"iDisplayLength": 10,
