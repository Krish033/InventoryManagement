					...
					<div class="card-body ">
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									...
									<input class="form-control" id="txtGST" type="text" value="<?php if ($isEdit == true) {
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<input class="form-control" id="Percentage" step="0.01" type="number" value="<?php if ($isEdit == true) {
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<select class="form-control" id="lstActiveStatus">
										<option @if ($isEdit == true && $EditData[0]->ActiveStatus == '1') selected @endif value="1">Active
										</option>
										<option @if ($isEdit == true && $EditData[0]->ActiveStatus == '0') selected @endif value="0">Inactive
										</option>
									</select>
						...
						<div class="row">
							<div class="col-sm-12 text-right">
								@if ($crud['view'] == true)
									<a class="btn btn-sm btn-outline-dark" href="{{ url('/') }}/master/tax" id="btnCancel">Back</a>
								@endif
	...
	<script>
		$(document).ready(function() {
			const formValidation = () => {
				...
				if (GST == "") {
					$('#txtGST-err').html('The category name is required.');
					status = false;
				} else if (GST.length < 2) {
					$('#Percentage-err').html('GST  must be greater than 2 characters');
					status = false;
				} else if (GST.length > 100) {
					$('#txtGST-err').html('Category Name may not be greater than 100 characters');
					status = false;
				}

				if (Percentage == "") {
					$('#Percentage-err').html('The Percentage  is required.');
					status = false;
				} else if (Percentage.length > 100) {
					$('#Percentage-err').html('Percentage  may not be greater than 100 characters');
					status = false;
				}
