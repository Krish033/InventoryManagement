		...
		<div class="row">
			<div class="col-sm-12">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="{{ url('/') }}/master/tax/" data-original-title="" title="">customer</a></li>
						...
						<div class="card-header text-center">
							<div class="form-row align-items-center">
								...
								<div class="col-md-4 my-2">
									<h5>Uom Trash View</h5>
								</div>
								<div class="col-md-4 my-2 text-right text-md-right">
									<a href="{{ url('/') }}/master/unit-of-measurement" class="btn  btn-outline-light btn-sm m-r-10" type="button" > Back</a>
								</div>
							</div>
						</div>
						<div class="card-body " >
    ...
    $(document).ready(function(){
        ...
        const LoadTable=async()=>{
			...
			$('#tblcustomer').dataTable( {
				"bProcessing": true,
				"bServerSide": true,
                "ajax": {"url": RootUrl+"master/uom/trash-data?_token="+$('meta[name=_token]').attr('content'),"headers":{ 'X-CSRF-Token' : $('meta[name=_token]').attr('content') } ,"type": "POST"},
				deferRender: true,
				responsive: true,
				dom: 'Bfrtip',
				"iDisplayLength": 10,
