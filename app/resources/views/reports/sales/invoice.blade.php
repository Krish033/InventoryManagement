@extends('reports.purchase.index')
@section('styles')
<style>
    body {
        margin-top: 20px;
        ...
        <div class="col-lg-10 col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="fs-sm">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae repellendus reprehenderit
                        fugiat
                    </p>
                    ...
                    <table class="table border-bottom border-gray-200 mt-3">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="fs-sm text-dark text-uppercase-bold-sm px-0">No. of purchase
                                </th>
                        ...
                        <tbody>
                            <tr>
                                <td class="px-0">Average sales per year</td>
                                <td class="text-center px-0">5043</td>
                                <td class="text-end px-0">$60.00</td>
                            </tr>
                            <tr>
                                <td class="px-0">Total Sales</td>
                                <td class="text-center px-0">$80.00</td>
                                <td class="text-end px-0">$80.00</td>
                            </tr>
                            <tr>
                                <td class="px-0">Heighest Sold item - Lorem, ipsum.</td>
                                <td class="text-center px-0">3234</td>
                                <td class="text-end px-0">$80.00</td>
                            </tr>
                        </tbody>
                    </table>
