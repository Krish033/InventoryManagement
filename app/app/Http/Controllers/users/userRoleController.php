...
class userRoleController extends Controller{
	...
	public function index(Request $req){
		if($this->general->isCrudAllow($this->CRUD,"view")==true){
			...
			return view('Users.UserRoles.view',$FormData);
	...
	public function Create(Request $req){
		if($this->general->isCrudAllow($this->CRUD,"Add")==true){
			...
			return view('Users.UserRoles.userRole',$FormData);
		}elseif($this->general->isCrudAllow($this->CRUD,"view")==true){
			return Redirect::to('/User-And-Permissions/User-Roles');
		}else{
			return view('errors.403');
		}
	}
	...
	public function Save(Request $req){
		...
		if($this->general->isCrudAllow($this->CRUD,"add")==true){
			...
			if($status==true){
				...
				$logData=array("Description"=>"New User Role Created ","ModuleName"=>"User-Role","Action"=>"Add","ReferID"=>$RoleID,"OldData"=>$OldData,"NewData"=>$NewData,"UserID"=>$this->UserID,"IP"=>$req->ip());
	...
	public function Update(Request $req,$RoleID){
		...
		if($this->general->isCrudAllow($this->CRUD,"edit")==true){
			...
			if($status==true){
				...
				$logData=array("Description"=>"User Role Changed ","ModuleName"=>"User-Role","Action"=>"Update","ReferID"=>$RoleID,"OldData"=>$OldData,"NewData"=>$NewData,"UserID"=>$this->UserID,"IP"=>$req->ip());
				$this->logs->Store($logData);
